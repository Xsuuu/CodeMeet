...
const SessionPage = () => {
  ...
  const { streamClient, call, chatClient, channel, isInitializingCall } =
    useStreamClient(session, isLoadingSession, isHost, isParticipant);
              ...
              <Panel defaultSize={50} minSize={20}>
                <div className='h-full overflow-y-auto bg-base-200'>
                  ...
                  {problemData?.description && (
                    <div className='bg-base-100 rounded-xl shadow-sm p-5 border border-base-300 mt-3'>
                  ...
                  {problemData?.constraints &&
                    problemData.constraints.length > 0 && (
                      <div className='bg-base-100 rounded-xl shadow-sm p-5 border border-base-300 my-3'>
                        <h2 className='text-xl font-bold mb-4 text-base-content'>
                          Constraints
                        </h2>
